...
\begin{figure}
    ...
    \caption{\todo{Make the plots go from 0 to 1 on each axis and make a bit bigger. The lines are actually in the wrong position, need to do minus 25 to get the right shift I think.}}
